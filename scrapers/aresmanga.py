...
class AresMangaScraper(BaseScraper):
    def __init__(self):
        super().__init__("https://aresmanga.com") # قد يتغير الرابط

    def search(self, query):
        # تنفيذ البحث الخاص بموقع Ares Manga
    ...
    def get_manga_info(self, manga_url):
        # تنفيذ جلب معلومات المانغا الخاص بموقع Ares Manga
    ...
    def get_chapter_images(self, chapter_url):
        # تنفيذ جلب صور الفصل الخاص بموقع Ares Manga
